...
Опции install:
  ...
  --apt-wait <сек>      сколько ждать блокировку dpkg до остановки
                        автообновления (по умолчанию 60)
...
M[apt_stopping]="блокировку держит автообновление (%s) — останавливаю его штатно"
M[apt_foreign_holder]="блокировку держит %s (pid %s) — это не автообновление, снимать не буду"
